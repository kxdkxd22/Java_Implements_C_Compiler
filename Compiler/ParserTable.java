...
public class ParserTable {
    ...
    private void initYyPushTable(){
        ...
        int[] yyp3 = new int[]{SymbolDefine.EXPR_PRIME,SymbolDefine.ACTION_2,SymbolDefine.TERM,SymbolDefine.ACTION_0,SymbolDefine.PLUS};
        yy_pushtab.add(yyp3);
        ...
        int[] yyp6 = new int[]{SymbolDefine.TERM_PRIME,SymbolDefine.ACTION_3,SymbolDefine.FACTOR,SymbolDefine.ACTION_0,SymbolDefine.TIMES};
        yy_pushtab.add(yyp6);
    ...
    public int[] getPushTabItems(int whatToDo){return yy_pushtab.get(whatToDo);}
