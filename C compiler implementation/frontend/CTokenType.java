...
public enum CTokenType {
    ...
    //Enum
    ENUM_SPECIFIER,OPT_ENUM_LIST,ENUMERATOR_LIST,ENUMERATOR,ENUM_NT,CONST_EXPR,ARGS,
    ...
    RELOP,ANDAND,OR,AND,EQUOP,SHIFTOP,DIVOP,XOR,MINUS,INCOP,DECOP,STRUCTOP,RETURN,

    IF,ELSE,SWITCH,CASE,DEFAULT,BREAK,WHILE,FOR,DO,CONTINUE,GOTO,
    //Enum def
    ENUM,
