            ...
            case CGrammarInitializer.Binary_RelOP_Binary_TO_Binary:
                ...
                switch (operator){
                    case "==":
                        ...
                        break;
                    case ">":
                        generator.setComparingCmd(Instruction.IF_ICMPLE.toString()+" "+branch);
                        root.setAttribute(ICodeKey.VALUE,val1>val2?1:0);
                        break;
                    case "<":
                        generator.setComparingCmd(Instruction.IF_ICMPGE.toString()+" "+branch);
                        root.setAttribute(ICodeKey.VALUE,val1<val2?1:0);
                        break;
                    case ">=":
                        generator.setComparingCmd(Instruction.IF_ICMPLT.toString()+" "+branch);
                        root.setAttribute(ICodeKey.VALUE,val1>=val2?1:0);
                        break;
                    case "<=":
                        generator.setComparingCmd(Instruction.IF_ICMPGT.toString()+" "+branch);
                        root.setAttribute(ICodeKey.VALUE,val1<=val2?1:0);
                        break;
                    case "!=":
                        root.setAttribute(ICodeKey.VALUE,val1!=val2?1:0);
