public enum CTokenType {
    ...
    //Enum
    ENUM_SPECIFIER,OPT_ENUM_LIST,ENUMERATOR_LIST,ENUMERATOR,ENUM_NT,CONST_EXPR,
    ...
    //TERMINALS
    NAME,TYPE,STRUCT,CLASS,LP,RP,LB,RB,PLUS,LC,RC,NUMBER,
    ...
    public static boolean isTerminal(int val){
        ...
        if(val>=FIRST_TERMINAL_INDEX&&val<=LAST_TERMINAL_INDEX){
           return true;
        }
        return false;
    }
